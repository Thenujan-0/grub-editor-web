    ...
    <div id="main">
        ...
        <div id="how_it_works">
            ...
            <p>Unlike the grub customizer, grub editor performs the edits to <span id="cool" class="inline-code">etc/default/grub</span>
                ...
                <p>It currently uses <span class="inline-code">pkexec</span> to execute commands that require sudo permissions as i don't know how to use polkit 
            ...
            <div id="download">
                ...
                <div id="cards">
                    <div class="sub-download">
                        ...
                        <div class="code">
                            <p>
                                <i class='fa fa-angle-right'></i>git clone https://aur.archlinux.org/grub-editor.git<br>
                                <i class='fa fa-angle-right'></i>cd grub-editor<br>
                                <i class='fa fa-angle-right'></i>makepkg -si
                            </p>
